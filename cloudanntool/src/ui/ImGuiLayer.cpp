...
{
    if (initialized_) {
        CC_CORE_WARN("ImGuiLayer already initialized");
        return;
    }

    CC_CORE_INFO("Initializing ImGui layer...");
    ...
    initialized_ = true;
    CC_CORE_INFO("ImGui layer initialized successfully");
}
...
void ImGuiLayer::shutdown()
{
    ...
    CC_CORE_INFO("Shutting down ImGui layer...");
    ...
    initialized_ = false;
    CC_CORE_DEBUG("ImGui layer shutdown complete");
}
